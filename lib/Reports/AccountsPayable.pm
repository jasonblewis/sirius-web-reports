...
sub detailed_trial_balance {
 ...
 FROM   ("sirius9"."dbo"."term_rate" "term_rate" INNER JOIN ("sirius9"."dbo"."zz_ap_last_payment" "zz_ap_last_payment" RIGHT OUTER JOIN (("sirius9"."dbo"."zz_ap_allocation_total" "zz_ap_allocation_total" FULL OUTER JOIN "sirius9"."dbo"."ap_transaction" "ap_transaction" ON ("zz_ap_allocation_total"."batch_no"="ap_transaction"."batch_no") AND ("zz_ap_allocation_total"."batch_line_no"="ap_transaction"."batch_line_no")) INNER JOIN "sirius9"."dbo"."ap_creditor" "ap_creditor" ON "ap_transaction"."creditor_code"="ap_creditor"."creditor_code") ON "zz_ap_last_payment"."creditor_code"="ap_creditor"."creditor_code") ON "term_rate"."term_code"="ap_creditor"."term_code") INNER JOIN "sirius9"."dbo"."company" "company" ON "ap_creditor"."company_code"="company"."company_code"
